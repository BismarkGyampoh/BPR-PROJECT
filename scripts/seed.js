...
async function main() {
  ...
  await prisma.user.upsert({
   ...
   const riderPassword = await bcrypt.hash("rider1234", 12);
   await prisma.user.upsert({
     where: { phone: "+233240000002" },
     update: { password: riderPassword, role: "DELIVERY" },
     create: {
       id: "usr_rider_seed",
       name: "Kwofi Boateng",
       phone: "+233240000002",
   ...
   console.log("  - rider: +233240000002 / rider1234");
}
